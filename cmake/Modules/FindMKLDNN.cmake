...
IF(NOT MKLDNN_FOUND)
  ...
  IF(BUILD_ONEDNN_GRAPH)
    ...
    IF(CMAKE_COMPILER_IS_GNUCC)
      ...
      IF(DNNL_GRAPH_BUILD_COMPILER_BACKEND)
        TARGET_COMPILE_OPTIONS(graphcompiler PRIVATE -Wno-maybe-uninitialized)
        TARGET_COMPILE_OPTIONS(graphcompiler PRIVATE -Wno-strict-overflow)
        TARGET_COMPILE_OPTIONS(graphcompiler PRIVATE -Wno-error=strict-overflow)
      ENDIF(DNNL_GRAPH_BUILD_COMPILER_BACKEND)
  ...
  IF(BUILD_ONEDNN_GRAPH)
    ...
    IF(DNNL_GRAPH_BUILD_COMPILER_BACKEND)
      LIST(APPEND MKLDNN_LIBRARIES "$<TARGET_FILE:graphcompiler>")
    ENDIF(DNNL_GRAPH_BUILD_COMPILER_BACKEND)
  ENDIF(BUILD_ONEDNN_GRAPH)
